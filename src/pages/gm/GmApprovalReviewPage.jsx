...
import { CheckCheck, ChevronDown, RotateCcw, XCircle } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 xl:grid-cols-[1.65fr_0.85fr]">
        ...
        <div className="space-y-6 xl:sticky xl:top-28 xl:self-start">
          <Card>
            <h3 className="text-lg font-semibold text-slate-900">GM Decision</h3>
            <p className="mt-2 text-sm leading-6 text-slate-500">
              Add a comment if needed, then approve, return, or reject the request.
            </p>
            ...
            <div className="mt-5">
              <TextareaField
                label="Comment"
                rows={5}
                placeholder="Optional for approve. Required for return or reject."
                value={comment}
