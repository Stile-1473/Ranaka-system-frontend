  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <div>
          <h2 className="text-2xl font-semibold text-slate-900">GM Dashboard</h2>
          <p className="mt-1 text-sm text-slate-500">
            Review management approvals, handle urgent items, and keep decisions moving.
          </p>
        </div>
      ...
      <Card>
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          <div>
            <h3 className="text-lg font-semibold text-slate-900">Approval Trend</h3>
            <p className="mt-1 text-sm text-slate-500">
