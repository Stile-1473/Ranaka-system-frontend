...
const queueFilterMap = {
  ...
  high_value: (request) => Number(request.estimatedCost || 0) > 10000,
  critical: (request) => request.priority === "CRITICAL",
};
...
function PendingAuthorizationsPage() {
  ...
  const isOverdueView = location.pathname === "/ceo/overdue";
  ...
  const filteredQueue = useMemo(() => {
    ...
    const sorter = sortOptions[sortBy] || sortOptions.highest_cost;
    ...
    <div className="space-y-6">
      <div className="page-action-bar">
        <div className="page-action-copy">
          <p className="section-title">CEO Queue</p>
          <h2 className="page-action-title">
            {isOverdueView ? "Overdue Authorizations" : "Pending Authorizations"}
          </h2>
          <p className="page-action-subtitle">
            Focus on final-stage requests that are high value, urgent, or ready for executive authorization.
          </p>
        </div>
      ...
      <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
        ...
        <MetricTile label="High Value" value={stats.highValue} tone="warning" />
        <MetricTile label="Overdue" value={stats.overdue} tone="danger" />
        <MetricTile label="Critical" value={stats.critical} />
      </div>
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                <div className="relative min-w-[11rem] flex-1">
                  ...
                  >
                    ...
                    <option className="bg-slate-950 text-slate-100" value="high_value">
                      High value only
                    </option>
              ...
              <div className="px-6 py-12">
                <div className="rounded-[1.35rem] border border-dashed border-white/10 bg-white/[0.03] px-5 py-10 text-center">
                  ...
                  <p className="mt-2 text-sm leading-6 text-slate-400">
                    There are no executive authorizations matching the current search and filter.
                  </p>
                </div>
              </div>
            ) : (
                ...
                {filteredQueue.map((request) => (
                  ...
                  >
                    <div className="space-y-4 lg:hidden">
                      ...
                      >
                        <Link to={`/ceo/authorizations/${request.id}`}>
                          <span>Review</span>
