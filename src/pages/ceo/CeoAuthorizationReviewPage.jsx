    ...
    <div className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="mt-3 max-w-3xl text-sm leading-7 text-slate-400">
                Review the final request package, confirm the business case is ready for authorization, and decide whether it should be completed, returned, or rejected.
              </p>
            </div>
      ...
      <div className="grid gap-6 xl:grid-cols-[1.65fr_0.85fr]">
        <div className="space-y-6">
          ...
          <SectionBlock
            title="Overview"
            description="Core request context for executive authorization."
          >
        ...
        <div className="space-y-6 xl:sticky xl:top-28 xl:self-start">
          ...
          >
            <TextareaField
              ...
              placeholder="Add your authorization note, correction reason, or rejection reason..."
            ...
            <div className="mt-5 space-y-3">
              <DecisionButton
                ...
                helper="Use this when the request is complete and ready to be finalized."
                tone="success"
                disabled={busy}
