        ...
        <div className="space-y-6 xl:sticky xl:top-28 xl:self-start">
          <Card>
            ...
            <p className="mt-2 text-sm leading-6 text-slate-500">
              Add a comment if needed, then recommend, return, or reject the request.
            </p>
            ...
            <div className="mt-5">
              <TextareaField
                label="Comment"
                rows={5}
                placeholder="Optional for recommend. Required for return or reject."
                value={comment}
            ...
            <div className="mt-5 space-y-3">
              ...
              >
                {recommendStatus === "loading" ? "Recommending..." : "Recommend"}
              </Button>
              <Button
                variant="secondary"
                className="w-full border-amber-200 text-amber-700 hover:border-amber-300 hover:bg-amber-50 hover:text-amber-800"
                disabled={busy}
              ...
              <Button
                variant="secondary"
                className="w-full border-rose-200 text-rose-700 hover:border-rose-300 hover:bg-rose-50 hover:text-rose-800"
                disabled={busy}
